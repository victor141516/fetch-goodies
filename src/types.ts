...
type MethodBodyCombination =
  ...
  | { method?: VerbsWithBody; body?: never; json?: any }
  | { method?: VerbsWithoutBody; body?: never; json?: never }
...
export type GoodiesRequestOptions = RequestInit &
  FetchRequestInit &
...
export type GoodiesResponse<JSONType = any> = Omit<
  Response,
  'json' | 'text'
> & { json: () => JSONType | null } & {
  text: () => string
